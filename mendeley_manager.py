...
class MendeleyManager:
    ...
    def get_auth_url(self):
        ...
        scope = "all"  # Replace "all" with the specific scopes you need # all, read, write
    ...
    def get_access_token(self, auth_code):
        ...
        try:
            ...
            response = requests.post(token_url, data=data, auth=HTTPBasicAuth(self.client_id, self.client_secret))
    ...
    def list_documents_and_files_in_collection(self, access_token, collection_id):
        ...
        try:
            ...
            for document in documents:
                ...
                print(f"Fetching files for document: {document_title} (ID: {document_id})")
...
if __name__ == "__main__":
    ...
    collection_index = int(input("Enter the number of the collection to list documents and files: ")) - 1
    ...
    collection_data = manager.list_documents_and_files_in_collection(access_token, collection_id)
    ...
    for document in documents:
        ...
        if files:
            for file in files:
                ...
                downloaded_file = manager.download_file(access_token, file_id, save_path)
                if downloaded_file:
